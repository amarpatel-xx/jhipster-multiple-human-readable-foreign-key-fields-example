...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'idiom wonderfully hacienda', price: 28774.23 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="title"]`).type('hm why');
      cy.get(`[data-cy="title"]`).should('have.value', 'hm why');

      cy.get(`[data-cy="price"]`).type('388.82');
      cy.get(`[data-cy="price"]`).should('have.value', '388.82');
