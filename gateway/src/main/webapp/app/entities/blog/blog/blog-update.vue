      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.blogBlog.name')" for="blog-name"></label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.blogBlog.handle')" for="blog-handle"></label>
            <input
              type="text"
              class="form-control"
              name="handle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.blogBlog.user')" for="blog-user"></label>
