...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.saathratri.developer.blog.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.saathratri.developer.blog.security.DomainUserDetailsService", "createSpringSecurityUser");
