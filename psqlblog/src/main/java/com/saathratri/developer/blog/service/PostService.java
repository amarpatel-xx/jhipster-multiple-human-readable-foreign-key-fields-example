...
public interface PostService {
    ...
    /**
     * Get all the posts for saathratri orchestrator.
     *
     * @return the list of entities.
     */
    List<PostDTO> findAllForSaathratriOrchestrator();
     ...
     * @return the entity.
     */
    Optional<PostDTO> findOneWithEagerRelationships(UUID id);

    /**
     * Get all the posts.
     * @return the list of entities.
     */
    List<PostDTO> findAllWithEagerRelationships();
