...
@Repository
public interface BlogRepository extends ReactiveCrudRepository<Blog, UUID>, BlogRepositoryInternal {
    @Override
    Mono<Blog> findOneWithEagerRelationships(UUID id);
