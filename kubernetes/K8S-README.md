...
```
$ docker image tag gateway amarppatel/gateway
$ docker push amarppatel/gateway
$ docker image tag blog amarppatel/blog
$ docker push amarppatel/blog
$ docker image tag store amarppatel/store
$ docker push amarppatel/store
```
