...
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "psqlstoreProduct";
    ...
    /**
     * {@code GET  /saathratri-orchestrator} : get all the Products.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Products in body.
     */
    @GetMapping("/saathratri-orchestrator")
    public ResponseEntity<List<ProductDTO>> getAllProductsForSaathratriOrchestrator() {
        LOG.debug("REST request to get all Products for saathratri orchestrator");
        List<ProductDTO> entityList;
        entityList = productService.findAllForSaathratriOrchestrator();
