...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: 'ec1343bc-4940-45e5-91a5-e52d7da2aacd' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'psqlgatewayApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5c301dde-9e34-456a-b1f3-2a5e4aa00992');
      cy.get(`[data-cy="name"]`).should('have.value', '5c301dde-9e34-456a-b1f3-2a5e4aa00992');
