...
describe('Tag e2e test', () => {
  ...
  const tagSample = { name: 'electrocardiogram granular' };
  ...
  describe('new Tag page', () => {
    ...
    it('should create an instance of Tag', () => {
      cy.get(`[data-cy="name"]`).type('healthily edible access');
      cy.get(`[data-cy="name"]`).should('have.value', 'healthily edible access');
