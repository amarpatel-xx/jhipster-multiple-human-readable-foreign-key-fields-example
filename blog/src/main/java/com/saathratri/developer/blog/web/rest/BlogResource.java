...
public class BlogResource {
    ...
    public Mono<List<BlogDTO>> getAllBlogs(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<BlogDTO>> getBlog(@PathVariable("id") UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteBlog(@PathVariable("id") UUID id) {
