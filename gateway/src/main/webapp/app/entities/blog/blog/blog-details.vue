    ...
    <div class="col-8">
      <div v-if="blog">
        <h2 class="jh-entity-heading" data-cy="blogDetailsHeading">
          <span v-text="t$('gatewayApp.blogBlog.detail.title')"></span> {{ blog.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="t$('gatewayApp.blogBlog.name')"></span>
          </dt>
          <dd>
            <span>{{ blog.name }}</span>
          </dd>
          <dt>
            <span v-text="t$('gatewayApp.blogBlog.handle')"></span>
          </dt>
          <dd>
            <span>{{ blog.handle }}</span>
          </dd>
          <dt>
            <span v-text="t$('gatewayApp.blogBlog.user')"></span>
          </dt>
          <dd>
