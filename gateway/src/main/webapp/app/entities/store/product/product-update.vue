      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.storeProduct.title')" for="product-title"></label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.storeProduct.price')" for="product-price"></label>
            <input
              type="number"
              class="form-control"
              name="price"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.storeProduct.image')" for="product-image"></label>
            <div>
              <img
