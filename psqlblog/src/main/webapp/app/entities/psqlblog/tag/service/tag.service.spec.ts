...
describe('Tag Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Tag', () => {
      ...
      service.create(tag).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Tag', () => {
      ...
      service.update(tag).subscribe(resp => (expectedResult = resp));
    ...
    describe('compareTag', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '98ee8ea3-644a-40e1-a41d-945852ec36b4' };
        const entity2 = null;
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '98ee8ea3-644a-40e1-a41d-945852ec36b4' };
        const entity2 = { id: '98ee8ea3-644a-40e1-a41d-945852ec36b4' };
