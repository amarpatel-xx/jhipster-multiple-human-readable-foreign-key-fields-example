...
public interface BlogService {
    ...
    /**
     * Get all the blogs for saathratri orchestrator.
     *
     * @return the list of entities.
     */
    List<BlogDTO> findAllForSaathratriOrchestrator();
     ...
     * @return the entity.
     */
    Optional<BlogDTO> findOneWithEagerRelationships(UUID id);

    /**
     * Get all the blogs.
     * @return the list of entities.
     */
    List<BlogDTO> findAllWithEagerRelationships();
     ...
     * @return the entity.
     */
    Optional<BlogDTO> findOne(UUID id);
