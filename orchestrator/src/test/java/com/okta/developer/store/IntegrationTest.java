...
import com.okta.developer.store.OrchestratorApp;
...
@SpringBootTest(classes = { OrchestratorApp.class, AsyncSyncConfiguration.class, TestSecurityConfiguration.class })
@EmbeddedMongo
