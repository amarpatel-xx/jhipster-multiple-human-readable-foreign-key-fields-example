      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gatewayApp.blogTag.name')" for="tag-name"></label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label v-text="t$('gatewayApp.blogTag.post')" for="tag-post"></label>
            <select
              class="form-control"
              id="tag-posts"
              data-cy="post"
              ...
              v-model="tag.posts"
            >
              <option v-bind:value="getSelected(tag.posts, postOption, 'id')" v-for="postOption in posts" :key="postOption.id">
                {{ postOption.id }}
              </option>
            </select>
          </div>
