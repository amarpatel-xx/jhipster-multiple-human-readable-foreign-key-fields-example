...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.saathratri.developer.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.saathratri.developer.store.security.DomainUserDetailsService", "createSpringSecurityUser");
