<template>
  <div>
    <h2 id="page-heading" data-cy="PostHeading">
      <span v-text="t$('gatewayApp.blogPost.home.title')" id="post-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('gatewayApp.blogPost.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'PostCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-post">
            ...
            <span v-text="t$('gatewayApp.blogPost.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && posts && posts.length === 0">
      <span v-text="t$('gatewayApp.blogPost.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('title')">
              <span v-text="t$('gatewayApp.blogPost.title')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'title'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('content')">
              <span v-text="t$('gatewayApp.blogPost.content')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('date')">
              <span v-text="t$('gatewayApp.blogPost.date')"></span>
            ...
            <th scope="row" v-on:click="changeOrder('blog.name')">
              <span v-text="t$('gatewayApp.blogPost.blog')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="gatewayApp.blogPost.delete.question" data-cy="postDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-post-heading" v-text="t$('gatewayApp.blogPost.delete.question', { id: removeId })"></p>
      </div>
