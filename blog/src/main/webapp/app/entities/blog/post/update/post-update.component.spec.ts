...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: '8494833e-3e61-418e-a228-7c7e3ac5c631' };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: '530c7f90-1314-4b51-992f-67d0bc892684' }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const tags: ITag[] = [{ id: '1f4a05c0-f40f-4bb4-b477-d3f96f83dae1' }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: '7c8ddb15-44fe-4670-ae50-2c1e26ca7dda' }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const blog: IBlog = { id: 'b2d43146-b22a-42f9-a73b-8e4e62587e8b' };
      post.blog = blog;
      const tag: ITag = { id: '15e2bb05-c43a-4fd2-8d88-e807d82ffe74' };
      post.tags = [tag];
