...
describe('Post Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'a160eb1a-708c-49ba-b8e5-91e7bc01ba3f' }], {
    ...
    expect(comp.posts()[0]).toEqual(expect.objectContaining({ id: 'a160eb1a-708c-49ba-b8e5-91e7bc01ba3f' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: 'a160eb1a-708c-49ba-b8e5-91e7bc01ba3f' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: 'a160eb1a-708c-49ba-b8e5-91e7bc01ba3f' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
