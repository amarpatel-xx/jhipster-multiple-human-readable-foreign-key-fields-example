...
describe('Post Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'blog/post', component: PostComponent }]), HttpClientTestingModule, PostComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.posts?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
