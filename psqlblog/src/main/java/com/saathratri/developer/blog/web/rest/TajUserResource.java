...
public class TajUserResource {
    ...
    private static final String ENTITY_NAME = "psqlblogTajUser";
    ...
    /**
     * {@code GET  /taj-users} : get all the Taj Users.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Taj Users in body.
     */
    @GetMapping("")
    ...
    /**
     * {@code GET  /saathratri-orchestrator} : get all the Taj Users.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Taj Users in body.
     */
    @GetMapping("/saathratri-orchestrator")
    public ResponseEntity<List<TajUserDTO>> getAllTajUsersForSaathratriOrchestrator() {
        LOG.debug("REST request to get all TajUsers for saathratri orchestrator");
        List<TajUserDTO> entityList;
        entityList = tajUserService.findAllForSaathratriOrchestrator();
