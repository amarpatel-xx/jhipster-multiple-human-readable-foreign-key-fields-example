...
import com.saathratri.developer.blog.repository.rowmapper.TagRowMapper;
...
class TagRepositoryInternalImpl extends SimpleR2dbcRepository<Tag, String> implements TagRepositoryInternal {
    ...
    @Override
    public Mono<Tag> findById(String id) {
