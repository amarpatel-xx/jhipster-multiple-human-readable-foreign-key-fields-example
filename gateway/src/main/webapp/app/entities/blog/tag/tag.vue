<template>
  <div>
    <h2 id="page-heading" data-cy="TagHeading">
      <span v-text="t$('gatewayApp.blogTag.home.title')" id="tag-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('gatewayApp.blogTag.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'TagCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-tag">
            ...
            <span v-text="t$('gatewayApp.blogTag.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && tags && tags.length === 0">
      <span v-text="t$('gatewayApp.blogTag.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="t$('gatewayApp.blogTag.name')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="gatewayApp.blogTag.delete.question" data-cy="tagDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-tag-heading" v-text="t$('gatewayApp.blogTag.delete.question', { id: removeId })"></p>
      </div>
