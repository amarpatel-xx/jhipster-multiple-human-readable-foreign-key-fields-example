...
class PostRepositoryInternalImpl extends SimpleR2dbcRepository<Post, String> implements PostRepositoryInternal {
    ...
    @Override
    public Mono<Post> findOneWithEagerRelationships(String id) {
        return findById(id);
    }
