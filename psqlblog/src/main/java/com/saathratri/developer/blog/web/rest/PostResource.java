...
public class PostResource {
    ...
    private static final String ENTITY_NAME = "psqlblogPost";
    ...
    /**
     * {@code GET  /saathratri-orchestrator} : get all the Posts.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Posts in body.
     */
    @GetMapping("/saathratri-orchestrator")
    public ResponseEntity<List<PostDTO>> getAllPostsForSaathratriOrchestrator() {
        LOG.debug("REST request to get all Posts for saathratri orchestrator");
        List<PostDTO> entityList;
        entityList = postService.findAllForSaathratriOrchestrator();
